...
const firstName = prompt('Zadej sve krestni jmeno:').trim().toLowerCase().slice(0, 3);
const lastName = prompt('Zadej sve prijmeni:').trim().toLowerCase().slice(0, 5);

document.body.innerHTML += `
<p>Mas pridelen e-mail: ${lastName}${firstName} ${domain} </p>
`
